...
const Message = () => {
  ...
  return (
    <div className="flex justify-between ">
      ...
      {/* Chat zone */}
      <div className="w-[63%] h-[96vh] felx p-[24px] border-3 border-blue shadow-[0px_12px_23px_-2px_rgba(0,_0,_0,_0.1)] rounded-[20px] relative">
        {user?.userUID ? (
          <>
          ...
          <div className="flex items-center flex-col justify-center h-full text-center text-gray-500 text-xl">
            <span className="text-7xl text-blue ">
              <CiChat1 />
            </span>
            <h3 className="text-2xl text-gray-500 font-bold">
              Click a friend to start messaging
            </h3>
          </div>
        )}
      </div>
